...
public class GameWindow extends JFrame {
    ...
    Color rrbgColor = new Color(70, 84, 91);
    ...
    public GameWindow() {
        ...
        JButton buttonStartNewGame = new JButton("Start");

        buttonStartNewGame.setBackground(rbgColor);
        setLocationRelativeTo(null);//чтобы открывалось по центру
        panel.add(buttonStartNewGame);

        JButton buttonExit = new JButton("Exit");
        buttonExit.setForeground(rbgColor);

        buttonExit.setBackground(rrbgColor);
