...
public class Logic {
    ...
    static boolean checkWinLines(char dot) { //пробовала менять цвет победного символа в линии, поэтому ифы, не получилось
        for (int i = 0; i < SIZE; i++) {     //красит в любом случае все победные символы, а не в линии
            for (int j = 0; j < SIZE; j++) {
